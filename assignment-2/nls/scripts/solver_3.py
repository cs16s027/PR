...
if __name__ == '__main__':
    ...
    # Training
    mus, covs = train(data, 'plots/C-3/train/4/data.jpg',\
                            'plots/C-3/train/4/pdf.jpg',\
                            'plots/C-3/train/4/contours.jpg',\
                            'plots/C-3/train/4/boundaries.jpg',\
                             (1, 1))   
    # Save model
    saveModel([mus, covs], 'models/C-3/4/model.h5')
    # Load model
    mus, covs = loadModel('models/C-3/4/model.h5')
    # Validation
    data = h5py.File('data/valid.h5', 'r')
    rates = validate(data, [mus, covs], 'plots/C-3/valid/4/roc.jpg')
