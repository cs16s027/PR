...
from postProcess import computeROC, plotROC, printConfusionMatrix
...
def train(data, data_plot, pdf_plot, contour_plot, boundary_plot, choice):
    ...
    mus, covs = estimateParams(data, choice)
...
if __name__ == '__main__':
    ...
    # Training
    mus, covs = train(data, 'plots/NaiveBayes/C-3/train/5/data.jpg',\
                            'plots/NaiveBayes/C-3/train/5/pdf.jpg',\
                            'plots/NaiveBayes/C-3/train/5/contours.jpg',\
                            'plots/NaiveBayes/C-3/train/5/boundaries.jpg',\
                             (2, 1))   
    # Save model
    saveModel([mus, covs], 'models/NaiveBayes/C-3/5/model.h5')
    # Load model
    mus, covs = loadModel('models/NaiveBayes/C-3/5/model.h5')
    # Validation
    data = h5py.File('data/valid.h5', 'r')
    rates = validate(data, [mus, covs], 'plots/NaiveBayes/C-3/valid/5/roc.jpg')
