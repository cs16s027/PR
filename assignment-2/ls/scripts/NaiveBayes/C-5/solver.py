...
if __name__ == '__main__':
    ...
    # Training
    mus, covs = train(data, 'plots/NaiveBayes/C-5/train/data.jpg',\
                            'plots/NaiveBayes/C-5/train/pdf.jpg',\
                            'plots/NaiveBayes/C-5/train/contours.jpg',\
                            'plots/NaiveBayes/C-5/train/boundaries.jpg')
    # Save model
    saveModel([mus, covs], 'models/NaiveBayes/C-5/model.h5')
    # Load model
    mus, covs = loadModel('models/NaiveBayes/C-5/model.h5')
    # Validation
    data = h5py.File('data/valid.h5', 'r')
    rates = validate(data, [mus, covs], 'plots/NaiveBayes/C-5/valid/roc.jpg')
