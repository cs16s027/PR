...
if __name__ == '__main__':
    ...
    # Training
    mus, covs = train(data, 'plots/C-4/train/0/data.jpg',\
                            'plots/C-4/train/0/pdf.jpg',\
                            'plots/C-4/train/0/contours.jpg',\
                            'plots/C-4/train/0/boundaries.jpg',\
                             0)   
    # Save model
    saveModel([mus, covs], 'models/C-4/0/model.h5')
    # Load model
    mus, covs = loadModel('models/C-4/0/model.h5')
    # Validation
    data = h5py.File('data/valid.h5', 'r')
    rates = validate(data, [mus, covs], 'plots/C-4/valid/0/roc.jpg')
