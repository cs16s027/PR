...
from estimate_parameters import estimateParams4
...
def train(data, data_plot, pdf_plot, contour_plot, boundary_plot, choice):
    ...
    mus, covs = estimateParams4(data, choice)
...
if __name__ == '__main__':
    ...
    # Training
    mus, covs = train(data, 'plots/NaiveC-4/train/0/data.jpg',\
                            'plots/NaiveC-4/train/0/pdf.jpg',\
                            'plots/NaiveC-4/train/0/contours.jpg',\
                            'plots/NaiveC-4/train/0/boundaries.jpg',\
                             0)   
    # Save model
    saveModel([mus, covs], 'models/NaiveC-4/0/model.h5')
    # Load model
    mus, covs = loadModel('models/NaiveC-4/0/model.h5')
    # Validation
    data = h5py.File('data/valid.h5', 'r')
    rates = validate(data, [mus, covs], 'plots/NaiveC-4/valid/0/roc.jpg')
