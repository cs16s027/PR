...
def plotROCs(rates_list, plot):
    ...
    ax.legend([red, green, blue, yellow, cyan], ['1', '5', '10', '40', '80'])
    plt.savefig(plot)
...
if __name__ == '__main__':
    rates_list = []
    for model in [1, 5, 10, 40, 80]:
        # Get the ROC data-points
        rates = computeROC('results/dtw/dtw_%s.txt' % model)
        # Add to rates_list
        rates_list.append(rates)
    plotROCs(rates_list, 'plots/dtw/roc.jpg')
    plotDETs(rates_list, 'plots/dtw/det.jpg')
